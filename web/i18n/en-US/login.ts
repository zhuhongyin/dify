const translation = {
  ...
  welcome: '👋 Welcome to Dtct, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Dtct Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Dtct',
  invalid: 'The link has expired',
  explore: 'Explore Dtct',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Dtct and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Dtct Enterprise license for your workspace has expired. Please contact your administrator to continue using Dtct.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Dtct license server. Please contact your administrator to continue using Dtct.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Dtct Enterprise license for your workspace is inactive. Please contact your administrator to continue using Dtct.',
}
